...
- `TESTFLIGHT_BUILD_NUMBER=2 TESTFLIGHT_CHANGELOG='Tester notes' fastlane distribute_internal_build`: attach an already processed build to the existing Private Testing group without uploading again. This keeps external beta review disabled.
