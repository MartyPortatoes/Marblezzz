...
struct TutorialView: View {
    ...
    private let lessons: [Lesson] = [
        ...
        Lesson(id: 2, icon: "arrow.right", title: "Let the cards lead.", body: "Play one card and move one marble its full distance. Number cards move their value, except 3 goes backward. A queen moves 12.", example: "Seven is an ordinary move of seven, not a split move. There are no extra turns."),
