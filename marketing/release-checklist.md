<!-- Reference copy from docs/RELEASE_CHECKLIST.md for this marketing package. -->
# Release gates
...
- [ ] Select the publishing Apple Developer team; reserve/verify bundle ID `com.marblezzz.app` and the Marblezzz App Store name.
